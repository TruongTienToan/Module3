...
public class ProductServiceMySQL extends DBContext implements ProductService{
    ...
    private static final String INSERT_PRODUCT = "INSERT INTO `product` (`name`, `quantity`, `price`, `description`) VALUES (?, ?, ?, ?)";
    private static final String DELETE_PRODUCT = "DELETE FROM `product` WHERE (`id` = ?);";
    private static final String FIND_PRODUCT_BY_ID = "SELECT * FROM product where id = ?";
    private static final String UPDATE_PRODUCT = "UPDATE `product` SET `name` = ?, `quantity` = ?, `price` = ?, `description` = ? WHERE (`id` = ?);";
