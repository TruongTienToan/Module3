...
insert into nha_cung_cap(ma_nha_cung_cap,ten_nha_cung_cap,dia_chi) values (1,"ix","ha noi");
insert into nha_cung_cap(ma_nha_cung_cap,ten_nha_cung_cap,dia_chi) values (2,"oo","hue");
insert into nha_cung_cap(ma_nha_cung_cap,ten_nha_cung_cap,dia_chi) values (3,"pp","da nang");
